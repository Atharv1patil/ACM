...
<div className="md:w-1/2 space-y-6 text-center md:text-left">
  <h1 className="text-4xl md:text-5xl font-bold leading-tight">
    ✨{" "}
    <DecryptedText
      text="Welcome to ACM Student Chapter"
      speed={50}
      maxIterations={20}
      characters="ABCDEFGHIJKLMNOPQRS1234567890!@#$%^&*"
  ...
  <p className="text-gray-300 text-lg">
    <DecryptedText
      text="Empowering students through technology, innovation, and collaboration. Join our workshops, hackathons, and tech fests to grow as a developer, thinker, and leader."
      speed={50}
      maxIterations={40}
